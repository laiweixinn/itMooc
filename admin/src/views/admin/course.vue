        ...
        <div class="thumbnail search-thumbnail">
          ...
          <div class="caption">
            <div class="clearfix">
              ...
              <span
                  class="pull-right label label-primary info-label">{{ COURSE_CHARGE | optionKV(course.charge) }}</span>
              <span
                  class="pull-right label label-primary info-label">{{ COURSE_STATUS | optionKV(course.status) }}</span>
            </div>
